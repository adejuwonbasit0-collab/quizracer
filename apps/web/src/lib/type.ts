...
// All shared types inlined here — no external package needed
...
export interface ClientToServerEvents {
  'room:create':     (data: { name: string; mode: string; isPrivate: boolean; maxPlayers: number }, cb?: (res: any) => void) => void;
  ...
  'matchmaking:join':    (data: { mode: string }, cb?: (res: any) => void) => void;
